...
CMeshDataGenerator::CMeshDataGenerator(void)
{
}
...
MeshData* CMeshDataGenerator::CreateTriangle(const std::string& geometryID, float size, EVertexType vertexType,
...
MeshData* CMeshDataGenerator::CreateTriangleTriColour(const std::string& geometryID, float size, EVertexType vertexType,
		const DirectX::XMFLOAT4& colour)
{
	// Create mesh data
	MeshData* pNewGeometry = new MeshData(vertexType, 3, 3);
...
MeshData* CMeshDataGenerator::CreateCube(const std::string& geometryID, float size, float tessellation, EVertexType vertexType,
	const DirectX::XMFLOAT4& colour)
{
...
MeshData* CMeshDataGenerator::CreatePlane(const std::string& geometryID, float size, float tessellation, EVertexType vertexType,
		const DirectX::XMFLOAT4& colour)
{
	// Total number of vertices of the cube
...
MeshData* CMeshDataGenerator::CreateSinPlane(const std::string& geometryID, float size, float tessellation, EVertexType vertexType,
		const DirectX::XMFLOAT4& colour)
{
	// Total number of vertices of the cube
	int totalVerts = (tessellation + 1) * (tessellation + 1);
